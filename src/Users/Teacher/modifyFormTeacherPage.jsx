  ...
  useEffect(() => {
    ...
    function fillForm(dataset) {
        ...
        dataset.questions.map((question, index) => {
            addNewQuestion()
            document.getElementById('question-' + qInc).value = question.title
            document.getElementById('select-' + qInc).value = question.type
            qInc += 1
            if (question.type === 'multiple') {
                ...
                if (question.answers.length > 2) {
                    // ajouter enlever une réponse bouton
                }
                // ajouter une réponse bouton
            }
            return null
        })
        console.log(qInc)
        ...
        if (dataset.questions.length > 0) {
            // ajouter enlever une question bouton
        }
    }
