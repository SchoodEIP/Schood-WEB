...
const AlertModificationPopupContent = (alertObject, type) => {
  const roleProfile = sessionStorage.getItem('role')
  const [userRoles, setUserRoles] = useState([])
  const [userClasses, setUserClasses] = useState([])
  const [title, setTitle] = useState(alertObject.title)
  const [message, setMessage] = useState(alertObject.message)
